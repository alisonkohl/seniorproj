...
router.post('/', function(req, res, next) {
	...
	res.render('rateonemovie', {title: 'Find Movie', 'title': form_data.title, 'movieRating': form_data.movieRating, 'thumbnail': form_data.thumbnail, 'genreString': form_data.genres, 'year': form_data.year, 'recentFriends': form_data.recentFriends});
